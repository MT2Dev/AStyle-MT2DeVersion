@echo off
astyle -A1 -T -C -S -N -xW -xw -xg -xd -H -U -k1 -y -xb -j -xy -n -v EterPack.cpp EterPack.h EterPackCursor.cpp EterPackCursor.h EterPackManager.cpp EterPackManager.h Inline.h md5.c md5.h

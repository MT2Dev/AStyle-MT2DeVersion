@echo off
astyle -A1 -T -C -S -N -xW -xw -xg -xd -H -U -k1 -y -xb -j -xy -n -v SoundBase.cpp SoundBase.h SoundData.cpp SoundData.h SoundInstance.h SoundInstance2D.cpp SoundInstance3D.cpp SoundInstanceStream.cpp SoundManager.cpp SoundManager.h SoundManager2D.cpp SoundManager2D.h SoundManager3D.cpp SoundManager3D.h SoundManagerStream.cpp SoundManagerStream.h Type.cpp Type.h

@echo off
astyle -A1 -T -C -S -N -xW -xw -xg -xd -H -U -k1 -y -xb -j -xy -n -v PythonDebugModule.cpp PythonDebugModule.h PythonLauncher.cpp PythonLauncher.h PythonMarshal.cpp PythonMarshal.h PythonUtils.cpp PythonUtils.h Resource.cpp Resource.h

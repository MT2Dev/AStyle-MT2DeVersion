@echo off
astyle -A1 -T -C -S -N -xW -xw -xg -xd -H -U -k1 -y -xb -j -xy -n -v BoundaryShapeManager.cpp BoundaryShapeManager.h Constants.h SpeedTreeConfig.h SpeedTreeForest.cpp SpeedTreeForest.h SpeedTreeForestDirectX8.cpp SpeedTreeForestDirectX8.h SpeedTreeMaterial.h SpeedTreeWrapper.cpp SpeedTreeWrapper.h VertexShaders.h

@echo off
astyle -A1 -T -C -S -N -xW -xw -xg -xd -H -U -k1 -y -xb -j -xy -n -v building.h cache.h d3dtype.h item_length.h length.h pool.h singleton.h stl.h tables.h utils.h VnumHelper.h

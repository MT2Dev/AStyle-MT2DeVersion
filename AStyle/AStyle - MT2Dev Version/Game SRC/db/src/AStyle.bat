@echo off
astyle -A1 -T -C -S -N -xW -xw -xg -xd -H -U -k1 -y -xb -j -xy -n -v Cache.cpp Cache.h ClientManager.cpp ClientManager.h ClientManagerBoot.cpp ClientManagerEventFlag.cpp ClientManagerGuild.cpp ClientManagerHorseName.cpp ClientManagerLogin.cpp ClientManagerParty.cpp ClientManagerPlayer.cpp Config.cpp Config.h CsvReader.cpp CsvReader.h DBManager.cpp DBManager.h GuildManager.cpp GuildManager.h ItemAwardManager.cpp ItemAwardManager.h ItemIDRangeManager.cpp ItemIDRangeManager.h LoginData.cpp LoginData.h Main.cpp Main.h Marriage.cpp Marriage.h MoneyLog.cpp MoneyLog.h NetBase.cpp NetBase.h Peer.cpp Peer.h PeerBase.cpp PeerBase.h PrivManager.cpp PrivManager.h ProtoReader.cpp ProtoReader.h QID.h version.cpp

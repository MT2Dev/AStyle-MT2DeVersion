@echo off
astyle -A1 -T -C -S -N -xW -xw -xg -xd -H -U -k1 -y -xb -j -xy -n -v AsyncSQL.cpp AsyncSQL.h libsql.h Semaphore.cpp Semaphore.h Statement.cpp Statement.h Tellwait.cpp Tellwait.h

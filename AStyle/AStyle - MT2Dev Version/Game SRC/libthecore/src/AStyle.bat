@echo off
astyle -A1 -T -C -S -N -xW -xw -xg -xd -H -U -k1 -y -xb -j -xy -n -v buffer.cpp buffer.h crypt.h fdwatch.cpp fdwatch.h gost.cpp hangul.cpp hangul.h heart.cpp heart.h kstbl.cpp kstbl.h log.cpp log.h main.cpp main.h memcpy.cpp memcpy.h signal.cpp signal.h socket.cpp socket.h stdafx.h tea.cpp typedef.h utils.cpp utils.h
